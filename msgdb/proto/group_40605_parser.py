...
def parse_40605(blob: bytes | None) -> Parsed40605:
    ...
    try:
        ...
        try:
            ...
            return Parsed40605(ParseStatus.INVALID, error=f"protobuf={type(exc).__name__}; wire={wire_exc}")
        return Parsed40605(ParseStatus.WIRE_FALLBACK, wire_fields=fields, error=f"protobuf={type(exc).__name__}")